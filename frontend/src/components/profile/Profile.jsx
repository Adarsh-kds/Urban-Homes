...
const Profile = () => {
    ...
    const handleLogout = async function () {
        await axios.post("https://house-rental-backend-p9wx.onrender.com/auth/logout");
    ...
    const projectListFetch = async function () {
        try {
            const { data } = await axios.get("https://house-rental-backend-p9wx.onrender.com/post/properties");
            // console.log(data);
    ...
    const savedProjects = async function () {
        const { data } = await axios.get(`https://house-rental-backend-p9wx.onrender.com/post/savedposts/${user.id}`);
